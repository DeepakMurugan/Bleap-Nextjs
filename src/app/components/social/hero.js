...
import devImg from "../../assets/sections/sm.png";

export default function hero() {
  return (
    <section className="bg-[#F5F5F7]">
      {/* <div className="mx-auto container px-6 lg:px-10 py-16"> */}
                      <div className="mx-auto container px-6 py-8  lg:px-10 md:py-12 lg:py-16">
...
Scrolls into conversations! Followers into customers!          </p>
...
Our social media marketing strategies are designed to increase visibility, build trust, and drive meaningful engagement across platforms where your audience spends the most time.            </p>
