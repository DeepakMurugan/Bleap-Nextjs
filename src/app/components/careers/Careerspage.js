...
const JOBS = [
  ...
  },
  {
    ...
    applyEnabled: false, // management closed this role
  },
  {
    id: 7,
    ...
    posted: "Full Time",
    description:
      "Create SEO-friendly website, blog, and campaign content with strong clarity, structure, and brand tone.",
    applyEnabled: true,
  },
  {
    id: 8,
    ...
    posted: "Full Time",
    description:
      "Create social media creatives, ad banners, web visuals, and brand assets with a strong design sense.",
    applyEnabled: true,
  },
  {
    id: 9,
    ...
    posted: "Full Time",
    description:
      "Edit marketing videos, reels, performance creatives, and branded content with clean storytelling.",
    applyEnabled: true,
  },
  {
    id: 10,
    ...
    posted: "Full Time",
    description:
      "Build modern responsive websites and landing pages with strong frontend development skills.",
    applyEnabled: true,
  },
  {
    id: 11,
    ...
    posted: "Full Time",
    description:
      "Identify leads, manage outreach, support proposals, and drive new business opportunities.",
    applyEnabled: true,
  },
  {
    id: 12,
    ...
    posted: "Internship",
    description:
      "Support SEO, paid campaigns, research, and reporting while learning digital marketing execution.",
    applyEnabled: true,
  },
];
