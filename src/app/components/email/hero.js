...
import devImg from "../../assets/sections/emh.png";
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-[18px] font-medium text-[#000000]">
             Engage better! Convert more! Retain longer!
            </p>
          ...
          We create high-impact email marketing campaigns that turn subscribers into loyal customers, while keeping your messaging relevant, timely, and profitable.            </p>
