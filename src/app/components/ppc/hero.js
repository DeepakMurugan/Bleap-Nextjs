...
import devImg from "../../assets/sections/ppchero.png";
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-[18px] font-medium text-[#000000]">
              Spend smarter! Convert faster! Grow stronger!
            </p>
            ...
            <p className="mt-5 max-w-[520px] text-[16px] md:text-[15px] leading-7 text-neutral-600">
              We manage high-performing PPC campaigns that attract ready-to-convert customers while keeping your ad spend fully under control.
            </p>
