...
export default function TestimonialsMosaic() {
  ...
  return (
    ...
    <section className="bg-[#F4F4F4]">
         <h2 className="text-center text-[25px] md:text-[28px] font-semibold text-neutral-900 pt-3">
          Client <span className="text-[#ff6a00]">Testimonials</span>
        </h2>
		
      {/* <div className="mx-auto max-w-[1000px] px-6 lg:px-15 py-14"> */}
        <div className="mx-auto max-w-[1000px] px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-10 md:py-12 lg:py-14">
        {/* ================= DESKTOP ================= */}
