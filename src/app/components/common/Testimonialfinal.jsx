...
export default function Testimonialfinal() {
  ...
  const mobileLoopCards = [...testimonials, ...testimonials];

  return (
    <section className="bg-[#F4F4F4]">
      <h2 className="pt-3 text-center text-[25px] font-semibold text-neutral-900 md:text-[28px]">
        Client <span className="text-[#ff6a00]">Testimonials</span>
      </h2>

      <div className="mx-auto max-w-[1000px] px-4 py-8 sm:px-6 sm:py-10 md:px-8 md:py-12 lg:px-12 lg:py-14">
        {/* ================= DESKTOP ================= */}
        <div className="hidden items-center justify-center lg:flex">
          <div className="grid grid-cols-[1fr_280px_1fr] items-center gap-4">
            ...
            <div className="h-[700px] w-[260px] overflow-hidden rounded-[25px]">
              <div className="grid auto-up gap-4 hover:[animation-play-state:paused]">
            ...
            <div className="h-[700px] w-[260px] overflow-hidden rounded-[28px]">
              <div className="grid auto-down gap-4 hover:[animation-play-state:paused]">
          ...
          <div className="marquee-mobile flex w-max gap-3 sm:gap-4">
            {mobileLoopCards.map((item, index) =>
              item.type === "featured" ? (
                <div
                  key={`${item.id}-${index}`}
                  className="w-[84vw] max-w-[340px] shrink-0 rounded-[28px] bg-[#F37022] sm:w-[60vw]"
                >
                  <div className="p-3">
                    <div className="overflow-hidden rounded-[22px]">
                      <Image
                  ...
                  <div className="px-4 pb-5 sm:px-5">
                    <p className="text-[14px] leading-6 text-white sm:text-[15px]">
                      “{item.quote}”
                    </p>
                ...
                <div
                  key={`${item.id}-${index}`}
                  className="w-[84vw] max-w-[340px] shrink-0 sm:w-[60vw]"
                >
      ...
      <style jsx>{`
        ...
        .marquee-mobile {
          animation: marqueeMobile 24s linear infinite;
...
function TestimonialCard({ item }) {
  return (
    <div className="relative rounded-[25px] bg-[#ffffff] px-4 pb-5 pt-16 text-black shadow-[0_0_0_1px_rgba(255,255,255,0.02)] sm:px-5">
      ...
      <p className="text-[14px] leading-6 text-black sm:text-[15px]">
        “{item.quote}”
      </p>
